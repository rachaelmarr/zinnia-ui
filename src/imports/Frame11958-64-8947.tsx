import svgPaths from "./svg-blge5pkpnw";
  ...
  return (
    ...
    >
      <div className="flex flex-col font-['Montserrat:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px]">
        <p className="adjustLetterSpacing block leading-[1.5] whitespace-pre">10:00 AM</p>
      </div>
    </div>
  );
}
...
function TextInput() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-start justify-start p-0 relative shrink-0 w-[163px]"
...
function Frame135() {
  return (
    <div className="absolute box-border content-stretch flex gap-5 items-start justify-start left-0 p-0 top-1/2 translate-y-[-50%] w-[304px]">
      <div className="font-['Literata:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#47567b] text-[14px] tracking-[0.28px] w-[121px]">
        <p className="adjustLetterSpacing block leading-[1.5]">Arrival time</p>
      </div>
      <TextInput />
    </div>
  );
