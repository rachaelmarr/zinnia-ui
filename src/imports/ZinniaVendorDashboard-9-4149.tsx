import svgPaths from "./svg-fj1z58actr";
...
function IconButton() {
  return (
    <div
      className="absolute bg-[#ffffff] box-border content-stretch flex flex-row items-start justify-start left-0 p-[8.12903px] rounded-[101.613px] top-0"
      data-name="Icon Button"
    >
      <div className="absolute border-[#47567b] border-[1.01613px] border-solid inset-0 pointer-events-none rounded-[101.613px]" />
      <Pencil />
    </div>
  );
}
...
function IconButton1() {
  return (
    <div
      className="absolute bg-[#ffffff] box-border content-stretch flex flex-row items-start justify-start left-[47.419px] p-[8.12903px] rounded-[101.613px] top-0"
      data-name="Icon Button"
    >
      <div className="absolute border-[#47567b] border-[1.01613px] border-solid inset-0 pointer-events-none rounded-[101.613px]" />
      <Trash />
