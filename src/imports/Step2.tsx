import svgPaths from "./svg-okwl872z3l";
  ...
  return (
    <div className="absolute h-6 left-10 top-6 w-[143px]" data-name="Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 143 24">
        <g clipPath="url(#clip0_132_27775)" id="Logo">
          <path d={svgPaths.p2b86a00} fill="var(--fill-0, #47567B)" id="Zinnia" />
        </g>
        <defs>
          <clipPath id="clip0_132_27775">
  ...
  return (
    <div className="content-stretch flex font-['Literata:Medium',_sans-serif] font-medium gap-0.5 items-start justify-start leading-[0] relative shrink-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px]" data-name="Text Container">
      <div className="relative shrink-0">
        <p className="leading-[1.5] text-nowrap whitespace-pre">Status</p>
      </div>
      <div className="relative shrink-0">
...
function TextContainer3() {
  return (
    <div className="basis-0 content-stretch flex gap-0.5 grow items-start justify-start min-h-px min-w-px relative shrink-0" data-name="Text Container">
      <div className="flex flex-col font-['Montserrat:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#667593] text-[14px] text-nowrap tracking-[0.28px]">
        <p className="leading-[1.5] whitespace-pre">New Contact</p>
      </div>
    </div>
  );
}
...
function TextContainer4() {
  return (
    <div className="content-stretch flex font-['Literata:Medium',_sans-serif] font-medium gap-0.5 items-start justify-start leading-[0] relative shrink-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px]" data-name="Text Container">
      ...
      <div className="relative shrink-0">
        <p className="leading-[1.5] text-[14px] text-nowrap whitespace-pre">&nbsp;</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-2 items-center justify-start relative shrink-0 w-full" data-name=".Core - Helper Text">
      <div className="font-['Montserrat:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#667593] text-[14px] text-nowrap tracking-[0.28px]">
        <p className="leading-[1.5] whitespace-pre">Helper text</p>
      </div>
    </div>
  );
}
...
function Frame78() {
  return (
    <div className="content-stretch flex flex-col gap-3 items-start justify-start relative shrink-0">
      <div className="font-['Montserrat:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#47567b] text-[0px] tracking-[0.28px] w-[400px]">
        <p className="leading-[1.5] mb-4">
          <span className="font-['Literata:Medium',_sans-serif] font-medium text-[#47567b] text-[16px] tracking-[0.32px]">What are tags?</span>
          <span className="text-[14px]">
            <br aria-hidden="true" />
            Tags are custom labels you can assign to contacts. They help you organize and quickly find contacts with specific characteristics. For example, you might tag a contact as:
          </span>
        </p>
        <ul className="css-ed5n1g list-disc">
          <li className="leading-[1.5] mb-0 text-[14px]" style={{ marginInlineStart: "calc(1.5 * 1 * var(--list-marker-font-size, 0))" }}>
            <span className="font-['Montserrat:Medium',_sans-serif] font-medium tracking-[0.28px]">Follow-Up Needed</span>
            <span>{` if they require another call.`}</span>
          </li>
          <li className="leading-[1.5] mb-0 text-[14px]" style={{ marginInlineStart: "calc(1.5 * 1 * var(--list-marker-font-size, 0))" }}>
            <span className="font-['Montserrat:Medium',_sans-serif] font-medium tracking-[0.28px]">Event Inquiry</span>
            <span>{` if they’re interested in booking services for an event.`}</span>
          </li>
          <li className="leading-[1.5] text-[14px]" style={{ marginInlineStart: "calc(1.5 * 1 * var(--list-marker-font-size, 0))" }}>
            <span className="font-['Montserrat:SemiBold',_sans-serif] font-semibold tracking-[0.28px]">{`VIP `}</span>if they’re a loyal or high-value customer.
          </li>
        </ul>
      </div>
      <TextInput2 />
...
function Modal() {
  return (
    <div className="absolute bg-[#ffffff] box-border content-stretch flex flex-col gap-[70px] items-center justify-start pb-0 pt-5 px-5 rounded top-[136px] w-[668px]" data-name="Modal" style={{ left: "calc(25% + 26px)" }}>
...
export default function Step2() {
  return (
    <div className="bg-[#f0f5fa] overflow-clip relative rounded-xl size-full" data-name="Step 2">
