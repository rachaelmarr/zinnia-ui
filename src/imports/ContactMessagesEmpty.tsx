import svgPaths from "./svg-rboaic7krq";
...
import { imgScreenshot20250211At80525Pm2 } from "./svg-o4vxt";
...
function Contact() {
  return (
    <div className="absolute content-stretch flex flex-col gap-5 items-start justify-start left-9 top-6 w-[257px]" data-name="contact">
      <Frame6 />
      <Frame15 />
    </div>
  );
...
function Illustration() {
  return (
    <div className="relative shrink-0 size-[383px]" data-name="Illustration">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 383 383">
        <g id="Illustration">
          <path d={svgPaths.pc780e00} fill="var(--fill-0, #47567B)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-[#667493] box-border content-stretch flex gap-2 items-start justify-start overflow-clip px-3 py-2 relative rounded-3xl shrink-0" data-name=".Base - Button">
      <div className="font-['Montserrat:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[14px] text-neutral-50 text-nowrap tracking-[0.28px]">
        <p className="leading-[1.5] whitespace-pre">Send a message</p>
      </div>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-3 items-center justify-start left-[17px] top-[351px]">
      <div className="font-['Literata:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#47567b] text-[16px] text-center tracking-[0.32px] w-[604px]">
        <p className="leading-[1.5]">{`No messages yet. `}</p>
      </div>
      <div className="font-['Montserrat:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#000000] text-[14px] text-center tracking-[0.28px] w-[326px]">
        <p className="leading-[1.5]">Send a message and watch your conversations come to life—right here and in your inbox!</p>
      </div>
      <Button />
    </div>
  );
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-6 items-center justify-center top-[249px] w-[638px]" style={{ left: "calc(41.667% + 66px)" }}>
      <Illustration />
      <Frame3 />
    </div>
  );
...
export default function ContactMessagesEmpty() {
  return (
    <div className="bg-[#f0f5fa] overflow-clip relative rounded-xl size-full" data-name="Contact - messages - empty">
      <GlobalHeaderVendorAdmin />
      <Logo />
      <SideBar />
      <Frame5 />
      <Frame12033 />
      <div className="absolute font-['Montserrat:Regular',_sans-serif] font-normal leading-[1.5] text-[#47567b] text-[14px] text-nowrap top-[594px] tracking-[0.28px] whitespace-pre" style={{ left: "calc(58.333% + 1px)" }}>
        <p className="mb-4">&nbsp;</p>
        <p className="mb-4">&nbsp;</p>
        <p className="mb-4">&nbsp;</p>
        <p>&nbsp;</p>
