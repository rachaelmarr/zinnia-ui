import svgPaths from "./svg-gvbznv6ujp";
  ...
  return (
    <div className="h-6 relative shrink-0 w-[143px]" data-name="Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 143 24">
        <g clipPath="url(#clip0_96_4157)" id="Logo">
          <path d={svgPaths.p6d47c00} fill="var(--fill-0, #47567B)" id="Zinnia" />
        </g>
        <defs>
          <clipPath id="clip0_96_4157">
...
function Icons() {
  return (
    <div
      className="box-border content-stretch flex gap-3 items-start justify-start p-0 relative shrink-0 size-10"
      data-name="Icons"
    >
      <ActionIcons />
    </div>
...
function Header() {
  return (
    <div
      className="bg-[#ffffff] box-border content-stretch flex h-[76px] items-center justify-between px-4 py-5 relative shrink-0 w-[375px]"
      data-name="Header"
    >
      <div
        aria-hidden="true"
...
function Top() {
  return (
    <div
      className="box-border content-stretch flex gap-6 h-[52px] items-center justify-start p-0 relative shrink-0 w-full"
      data-name="Top"
    >
...
function ButtonDescription() {
  return (
    <div
      className="box-border content-stretch flex gap-3 h-[42px] items-center justify-start p-0 relative shrink-0 w-full"
      data-name="button+description"
    >
      <div className="font-['Montserrat:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#47567b] text-[14px] tracking-[0.28px] w-[205px]">
...
function Dashboard() {
  return (
    <div
      ...
      data-name="dashboard"
    >
      <div className="font-['Literata:ExtraBold',_sans-serif] font-extrabold leading-[0] relative shrink-0 text-[#47567b] text-[14px] tracking-[0.28px] w-full">
...
function Dashboard1() {
  return (
    <div
      ...
      data-name="dashboard"
    >
      <div className="font-['Literata:ExtraBold',_sans-serif] font-extrabold leading-[0] relative shrink-0 text-[#47567b] text-[14px] tracking-[0.28px] w-[209px]">
        <p className="adjustLetterSpacing block leading-[1.5]">Bank account information</p>
      </div>
      <ButtonDescription1 />
    </div>
  );
...
function ButtonDescription3() {
  return (
    <div
      className="box-border content-stretch flex gap-[26px] items-center justify-start p-0 relative shrink-0 w-full"
      data-name="button+description"
    >
      <div className="font-['Montserrat:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#47567b] text-[14px] tracking-[0.28px] w-[206px]">
...
function Steps() {
  return (
    <div
      className="bg-[#ffffff] box-border content-stretch flex gap-2.5 items-center justify-start overflow-clip px-[17px] py-0 relative shrink-0"
      data-name="Steps"
    >
...
function Top2() {
  return (
    <div
      className="box-border content-stretch flex gap-[17.503px] items-center justify-start p-0 relative shrink-0 w-[373px]"
      data-name="Top"
    >
...
function Day() {
  return (
    <div className="absolute bg-[#ffffff] left-0 size-[40.112px] top-0" data-name="day">
...
function Day1() {
  return (
    <div className="absolute bg-[#ffffff] h-[40.112px] left-[40.11px] top-0 w-[41.57px]" data-name="day">
...
function Day2() {
  return (
    <div className="absolute bg-[#ffffff] h-[40.112px] left-[81.68px] top-0 w-[42.3px]" data-name="day">
...
function Day3() {
  return (
    <div className="absolute bg-[#ffffff] left-[123.98px] rounded-[72.931px] size-[43.758px] top-0" data-name="day">
...
function Day4() {
  return (
    <div className="absolute bg-[#ffffff] h-[40.112px] left-[167.74px] top-0 w-[41.57px]" data-name="day">
      <div className="h-[40.112px] overflow-clip relative w-[41.57px]">
        <div className="absolute font-['Montserrat:Regular',_sans-serif] font-normal leading-[0] left-[21.37px] text-[#47567b] text-[12px] text-center text-nowrap top-[12.4px] tracking-[0.24px] translate-x-[-50%]">
...
function Day5() {
  return (
    <div className="absolute bg-[#ffffff] h-[40.112px] left-[209.31px] top-0 w-[43.029px]" data-name="day">
...
function Day6() {
  return (
    <div className="absolute bg-[#ffffff] h-[40.112px] left-[252.34px] top-0 w-[42.3px]" data-name="day">
      <div className="h-[40.112px] overflow-clip relative w-[42.3px]">
...
function Week3() {
  return (
    <div className="h-[43.758px] relative shrink-0 w-[299.015px]" data-name="Week 3">
      <Day />
      <Day1 />
      <Day2 />
      <Day3 />
...
function Day10() {
  return (
    <div className="absolute bg-[#ffffff] h-[40.112px] left-[123.98px] top-0 w-[43.758px]" data-name="day">
...
function Week6() {
  return (
    <div className="h-[43.758px] relative shrink-0 w-[299.015px]" data-name="Week 6">
      <Day7 />
      <Day8 />
      <Day9 />
      <Day10 />
...
function Day20() {
  return (
    <div className="absolute h-[40.112px] left-[252.34px] rounded-[72.931px] top-0 w-[42.3px]" data-name="day">
      <div className="h-[40.112px] overflow-clip relative w-[42.3px]">
        <div className="absolute font-['Montserrat:Regular',_sans-serif] font-normal leading-[0] left-[21.05px] text-[#47567b] text-[12px] text-center text-nowrap top-[12.4px] tracking-[0.24px] translate-x-[-50%]">
...
function Week7() {
  return (
    <div className="h-[43.758px] relative shrink-0 w-[299.015px]" data-name="Week 7">
      <Day14 />
      <Day15 />
      <Day16 />
      <Day17 />
...
function Day22() {
  return (
    <div className="absolute h-[40.112px] left-[40.11px] rounded-[72.931px] top-0 w-[41.57px]" data-name="day">
      <div className="h-[40.112px] overflow-clip relative w-[41.57px]">
...
function Day24() {
  return (
    <div className="absolute h-[40.112px] left-[123.98px] rounded-[72.931px] top-0 w-[43.758px]" data-name="day">
      <div className="h-[40.112px] overflow-clip relative w-[43.758px]">
...
function Week8() {
  return (
    <div className="h-[43.758px] relative shrink-0 w-[299.015px]" data-name="Week 8">
      <Day21 />
      <Day22 />
      <Day23 />
      <Day24 />
...
function Week9() {
  return (
    <div className="h-[43.758px] relative shrink-0 w-[299.015px]" data-name="Week 9">
      <Day28 />
      <Day29 />
      <Day30 />
      <Day31 />
...
function ChevronRight() {
  return (
    <div className="relative shrink-0 size-[17.503px]" data-name="chevron-right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="chevron-right">
          <path
...
function Frame127() {
  return (
    <div className="absolute box-border content-stretch flex gap-12 items-center justify-start left-7 p-0 top-6 w-72">
      <ChevronLeft />
      <div className="font-['Literata:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[#47567b] text-[16px] text-nowrap">
...
function ButtonOutlineManageAvailability() {
  return (
    <div
      className="absolute box-border content-stretch flex h-9 items-center justify-center p-0 top-[280px] translate-x-[-50%]"
...
function Calendar() {
  return (
    <div className="bg-[#ffffff] h-[340px] relative rounded-[11.669px] shrink-0 w-[321px]" data-name="Calendar">
  ...
  return (
    <div className="box-border content-stretch flex gap-2 items-center justify-start p-0 relative shrink-0">
      <div className="font-['Literata:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px]">
        <p className="adjustLetterSpacing block leading-[1.5] whitespace-pre">0 services listed | 0 views this month</p>
      </div>
    </div>
  );
}
...
function Chart() {
  return (
    <div
      className="box-border content-stretch flex gap-[22px] items-end justify-start p-0 relative shrink-0 w-full"
      data-name="Chart"
    >
...
function Years() {
  return (
    <div
      className="box-border content-stretch flex font-['Literata:Light',_sans-serif] font-light gap-[22px] items-end justify-start leading-[0] p-0 relative shrink-0 text-[#47567b] text-[14px] text-center tracking-[0.28px] uppercase w-full"
      data-name="years"
    >
...
function Top4() {
  return (
    <div
      className="box-border content-stretch flex gap-[17.503px] items-center justify-start p-0 relative shrink-0 w-full"
      data-name="Top"
    >
      <div className="basis-0 font-['Literata:SemiBold',_sans-serif] font-semibold grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#2e7684] text-[20px] text-center">
...
function Wedding() {
  return (
    <div
      className="box-border content-stretch flex gap-[50px] h-20 items-center justify-start p-0 relative shrink-0 w-[342px]"
      data-name="Wedding"
    >
      <TextBodyBookingInfo />
    </div>
...
function Frame13() {
  return (
    <div className="absolute box-border content-stretch flex font-['Literata:Light',_sans-serif] font-light inset-[86.93%_8.59%_3.82%_5.57%] items-center justify-between leading-[0] p-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px] uppercase">
...
function ChartGraphic1() {
  return (
    <div className="absolute contents inset-[-2.21%_8.59%_3.82%_5.57%]" data-name="chart-graphic">
...
function ChartEarnings() {
  return (
    <div className="h-[227px] relative shrink-0 w-full" data-name="Chart/earnings">
      <ChartGraphic1 />
        ...
        <div className="flex-none">
          <div className="relative size-full" data-name="Vector">
            <div className="absolute inset-[-2.91px_-0.96%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 310 6">
                <path
                  d={svgPaths.p24c6a00}
                  id="Vector"
                  stroke="var(--stroke-0, #47567B)"
