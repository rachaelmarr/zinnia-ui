import svgPaths from "./svg-0bzz90582g";
...
export default function BottomNav() {
  return (
    <div
      className="[flex-flow:wrap] bg-neutral-50 box-border content-start flex gap-0 items-start justify-center p-0 relative size-full"
