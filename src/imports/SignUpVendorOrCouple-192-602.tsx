import svgPaths from "./svg-3j35grqyco";
...
function CoupleHover() {
  return (
    <div className="bg-white relative rounded-[300px] shrink-0 size-[203px]" data-name="Couple/hover">
...
function BaseButton() {
  return (
    <div className="box-border content-stretch flex gap-2 items-start justify-start overflow-clip px-3 py-2 relative rounded-[24px] shrink-0" data-name=".Base - Button">
...
function BaseButton1() {
  return (
    <div className="basis-0 bg-[#667493] grow min-h-px min-w-px relative rounded-[24px] shrink-0" data-name=".Base - Button">
  ...
  return (
    <div className="content-stretch flex flex-col gap-4 items-center justify-start relative shrink-0" data-name="Timeline Step/Default">
      ...
      <div className="flex flex-col font-['Literata:Light',_sans-serif] font-light justify-center leading-[0] relative shrink-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px] uppercase">
        <p className="leading-[1.5] whitespace-pre">Get Started</p>
      </div>
    </div>
  );
}
...
function TimelineStepDefault1() {
  return (
    <div className="content-stretch flex flex-col gap-4 items-center justify-start relative shrink-0" data-name="Timeline Step/Default">
      <TimelineIllo1 />
      <div className="flex flex-col font-['Literata:Light',_sans-serif] font-light justify-center leading-[0] relative shrink-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px] uppercase">
        <p className="leading-[1.5] whitespace-pre">Vendor type</p>
      </div>
    </div>
  );
}
...
function TimelineStepDefault2() {
  return (
    <div className="content-stretch flex flex-col gap-4 items-center justify-start relative shrink-0" data-name="Timeline Step/Default">
      <TimelineIllo2 />
      <div className="flex flex-col font-['Literata:Light',_sans-serif] font-light justify-center leading-[0] relative shrink-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px] uppercase">
        <p className="leading-[1.5] whitespace-pre">Business info</p>
      </div>
    </div>
  );
}
...
function TimelineStepDefault3() {
  return (
    <div className="content-stretch flex flex-col gap-4 items-center justify-start relative shrink-0" data-name="Timeline Step/Default">
      <TimelineIllo3 />
      <div className="flex flex-col font-['Literata:Light',_sans-serif] font-light justify-center leading-[0] relative shrink-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px] uppercase">
        <p className="leading-[1.5] whitespace-pre">Create account</p>
      </div>
    </div>
  );
}
...
export default function SignUpVendorOrCouple() {
  return (
    <div className="bg-white overflow-clip relative rounded-[12px] size-full" data-name="Sign Up - Vendor or Couple">
      <Frame17 />
      <Frame11 />
      <Timeline />
      <X />
