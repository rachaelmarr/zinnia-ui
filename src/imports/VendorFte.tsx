import svgPaths from "./svg-olm9ig1611";
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-11 h-[72px] items-center justify-start px-10 py-4 relative w-full">
          <RightContent />
        </div>
      </div>
    </div>
...
function GlobalHeaderVendorAdmin() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row items-start justify-start left-0 p-0 top-0 w-[1440px]"
  ...
  return (
    <div className="absolute h-6 left-10 top-6 w-[143px]" data-name="Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 143 24">
        <g clipPath="url(#clip0_53_30576)" id="Logo">
          <path d={svgPaths.p6d47c00} fill="var(--fill-0, #47567B)" id="Zinnia" />
        </g>
        <defs>
          <clipPath id="clip0_53_30576">
...
function Button() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row h-9 items-center justify-center left-1/2 p-0 top-[420px] translate-x-[-50%]"
      data-name="Button"
    >
      <BaseButton />
    </div>
...
function Frame127() {
  return (
    <div className="absolute box-border content-stretch flex flex-row gap-[85px] items-center justify-start left-[38px] p-0 top-[65px]">
      <ChevronLeft />
...
function Top() {
  return (
    <div
      ...
      data-name="Top"
    >
      <div className="basis-0 font-['Literata:SemiBold',_sans-serif] font-semibold grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#2e7684] text-[20px] text-left">
...
function Frame13() {
  return (
    <div className="absolute bottom-[-1.02%] box-border content-stretch flex flex-row font-['Literata:Light',_sans-serif] font-light items-center justify-between leading-[0] left-[10.56%] p-0 right-0 text-[#47567b] text-[14px] text-left text-nowrap top-[91.79%] tracking-[0.28px] uppercase">
...
function Frame14() {
  return (
    <div className="absolute bg-[#ffffff] h-[289px] left-0 overflow-clip rounded-[20px] top-0 w-[670px]">
      <div className="absolute font-['Literata:SemiBold',_sans-serif] font-semibold leading-[0] left-10 text-[#47567b] text-[32px] text-left text-nowrap top-[66px]">
...
function Years() {
  return (
    <div
      className="box-border content-stretch flex flex-row font-['Literata:Light',_sans-serif] font-light items-end justify-between leading-[0] p-0 relative shrink-0 text-[#47567b] text-[14px] text-center tracking-[0.28px] uppercase w-full"
      data-name="years"
    >
...
function Button1() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row h-9 items-center justify-center left-1/2 p-0 top-[403px] translate-x-[-50%]"
      data-name="Button"
    >
      <BaseButton1 />
    </div>
...
function Frame128() {
  return (
    <div className="absolute box-border content-stretch flex flex-row gap-2 items-center justify-start left-10 p-0 top-[70px]">
...
function Frame11943() {
  return (
    <div
      className="absolute bg-[#ffffff] h-[459px] overflow-clip rounded-[20px] top-[608px] translate-x-[-50%] w-[440px]"
      style={{ left: "calc(83.333% - 21px)" }}
    >
      <div
        className="absolute font-['Literata:Medium',_sans-serif] font-medium leading-[0] text-[#47567b] text-[14px] text-left text-nowrap top-[350px] tracking-[0.28px]"
...
function Bookings() {
  return (
    <div
      className="absolute bg-[#ffffff] h-[285px] leading-[0] overflow-clip rounded-[20px] text-left top-[675px] w-[669px]"
      data-name="bookings"
...
function Breadcrumb3() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-2 items-center justify-start left-5 p-0 top-0 w-[648px]"
      data-name="Breadcrumb"
    >
      <div className="font-['Jost:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#667593] text-[12px] text-left text-nowrap">
...
function Top3() {
  return (
    <div
      ...
      data-name="Top"
    >
      <div className="basis-0 font-['Literata:SemiBold',_sans-serif] font-semibold grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#47567b] text-[32px] text-left">
...
function Top4() {
  return (
    <div
      ...
      data-name="Top"
    >
      <div className="basis-0 font-['Montserrat:Regular',_sans-serif] font-normal grow leading-[0] min-h-px min-w-px relative shrink-0 text-[#47567b] text-[14px] text-left tracking-[0.28px]">
  ...
  return (
    <div className="relative shrink-0 size-[46px]" data-name="Illustration">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 46 46">
        <g id="Illustration">
          <path d={svgPaths.pb14a300} fill="var(--fill-0, #47567B)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Illustration1() {
  return (
    <div className="relative rounded-[100px] shrink-0" data-name="illustration">
      <div className="box-border content-stretch flex flex-row gap-3 items-start justify-start overflow-clip p-[8px] relative">
        <Illustration />
      </div>
      <div
        aria-hidden="true"
...
function Text() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-1 items-start justify-start leading-[0] p-0 relative shrink-0 text-[#47567b] text-[14px] text-left tracking-[0.28px]"
      data-name="text"
    >
...
function IlloText() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-4 items-center justify-start left-5 p-0 top-0 w-[434px]"
      data-name="illo+text"
    >
      <Illustration1 />
      <Text />
...
function Button2() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row h-9 items-center justify-start left-[490px] p-0 top-[13px]"
      data-name="Button"
    >
      <BaseButton2 />
    </div>
...
function Illustration2() {
  return (
    <div className="relative shrink-0 size-[46px]" data-name="Illustration">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 46 46">
        <g id="Illustration">
          <path d={svgPaths.p364eb800} fill="var(--fill-0, #47567B)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function IlloText1() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-4 items-center justify-start left-5 p-0 top-0 w-[421px]"
      data-name="illo+text"
    >
      <Illustration3 />
      <Text1 />
...
function Button3() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row h-9 items-center justify-start left-[477px] p-0 top-[13px]"
      data-name="Button"
    >
      <BaseButton3 />
    </div>
...
function Illustration4() {
  return (
    <div className="relative shrink-0 size-[46px]" data-name="Illustration">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 46 46">
        <g id="Illustration">
          <path d={svgPaths.p167a6900} fill="var(--fill-0, #47567B)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function IlloText2() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-4 items-center justify-start left-5 p-0 top-0 w-[424px]"
      data-name="illo+text"
    >
      <Illustration5 />
      <Text2 />
...
function Button4() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row h-9 items-center justify-start left-[480px] p-0 top-[13px]"
      data-name="Button"
    >
      <BaseButton4 />
    </div>
...
function IlloText3() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-4 items-center justify-start left-5 p-0 top-0 w-[446px]"
      data-name="illo+text"
    >
      <Illustration7 />
      <Text3 />
...
function Button5() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row h-9 items-center justify-start left-[502px] p-0 top-[13px]"
      data-name="Button"
    >
      <BaseButton5 />
    </div>
...
function BaseLeftNavItem() {
  return (
    ...
    >
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-row gap-3 items-start justify-start px-3 py-1.5 relative w-full">
          <Home />
          <div className="basis-0 font-['Montserrat:Regular',_sans-serif] font-normal grow leading-[0] min-h-px min-w-px relative shrink-0 text-[14px] text-left text-neutral-100 tracking-[0.28px]">
...
export default function VendorFte() {
  return (
    <div className="bg-[#f0f5fa] overflow-clip relative rounded-xl size-full" data-name="Vendor - FTE">
