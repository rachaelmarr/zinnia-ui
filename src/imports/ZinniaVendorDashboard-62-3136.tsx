import svgPaths from "./svg-y93zotu5pg";
...
function Top() {
  return (
    <div
      ...
      data-name="Top"
    >
      <div className="font-['Literata:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[#47567b] text-[32px] w-[360px]">
...
function Top1() {
  return (
    <div
      ...
      data-name="Top"
    >
      <div className="font-['Literata:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[#ccd7e6] text-[32px] w-[360px]">
...
function Frame129() {
  return (
    <div className="absolute box-border content-stretch flex gap-1 items-center justify-start left-[13px] p-0 top-[88px]">
      <Frame126 />
      <Frame2609510 />
    </div>
  );
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] font-['Montserrat:SemiBold',_sans-serif] font-semibold ml-[18px] mt-0 relative text-[#667593] text-[12px] text-center text-nowrap tracking-[0.48px] translate-x-[-50%] uppercase">
        <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">Thu</p>
      </div>
      <div className="[grid-area:1_/_1] font-['Literata:SemiBold',_sans-serif] font-semibold ml-[18.5px] mt-[15px] relative text-[#667593] text-[32px] text-center text-nowrap tracking-[1.28px] translate-x-[-50%] uppercase">
        <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">26</p>
      </div>
      <div className="[grid-area:1_/_1] ml-[17px] mt-[59px] relative size-1">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 4">
          <circle cx="2" cy="2" fill="var(--fill-0, #667593)" id="Ellipse 1" r="2" />
        </svg>
      </div>
    </div>
  );
...
function Date() {
  return (
    <div
      className="box-border content-stretch flex gap-2.5 items-center justify-start p-[12px] relative rounded-lg shrink-0"
      data-name="Date"
    >
      <div
        aria-hidden="true"
        className="absolute border border-[#667593] border-solid inset-0 pointer-events-none rounded-lg"
      />
      <Group129 />
    </div>
  );
  ...
  return (
    <div className="font-semibold grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 text-[#667593] text-center text-nowrap uppercase">
      <div className="[grid-area:1_/_1] font-['Montserrat:SemiBold',_sans-serif] ml-[17px] mt-0 relative text-[12px] tracking-[0.48px] translate-x-[-50%]">
        <p className="adjustLetterSpacing block leading-[normal] text-nowrap whitespace-pre">FRI</p>
      </div>
      <div className="[grid-area:1_/_1] font-['Literata:SemiBold',_sans-serif] ml-[17.5px] mt-[15px] relative text-[32px] tracking-[1.28px] translate-x-[-50%]">
        <p className="adjustLetterSpacing block leading-[normal] text-nowrap whitespace-pre">27</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="font-semibold grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 text-[#667593] text-center text-nowrap uppercase">
      <div className="[grid-area:1_/_1] font-['Montserrat:SemiBold',_sans-serif] ml-[18.5px] mt-0 relative text-[12px] tracking-[0.48px] translate-x-[-50%]">
        <p className="adjustLetterSpacing block leading-[normal] text-nowrap whitespace-pre">Sat</p>
      </div>
      <div className="[grid-area:1_/_1] font-['Literata:SemiBold',_sans-serif] ml-[18.5px] mt-[15px] relative text-[32px] tracking-[1.28px] translate-x-[-50%]">
        <p className="adjustLetterSpacing block leading-[normal] text-nowrap whitespace-pre">28</p>
      </div>
    </div>
  );
}
...
function Group132() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      >
        <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">sun</p>
      </div>
      <div
        ...
        style={{ WebkitTextFillColor: "transparent" }}
      >
        <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">29</p>
      </div>
      <div className="[grid-area:1_/_1] ml-[17px] mt-[59px] relative size-1">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 4">
          <circle cx="2" cy="2" fill="url(#paint0_linear_62_3178)" id="Ellipse 1" r="2" />
          <defs>
            <linearGradient
              gradientUnits="userSpaceOnUse"
              id="paint0_linear_62_3178"
              x1="-0.0592593"
              x2="3.11745"
              y1="-3.38211"
              y2="-3.26293"
...
function Date3() {
  return (
    <div
      className="bg-[#ccd7e6] box-border content-stretch flex gap-2.5 items-center justify-start p-[12px] relative rounded-lg shrink-0"
      data-name="Date"
    >
      <div
        aria-hidden="true"
        className="absolute border-2 border-[#1a2652] border-solid inset-0 pointer-events-none rounded-lg"
      />
      <Group132 />
    </div>
  );
  ...
  return (
    <div className="font-semibold grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 text-[#667593] text-center text-nowrap uppercase">
      <div className="[grid-area:1_/_1] font-['Montserrat:SemiBold',_sans-serif] ml-[19.5px] mt-0 relative text-[12px] tracking-[0.48px] translate-x-[-50%]">
        <p className="adjustLetterSpacing block leading-[normal] text-nowrap whitespace-pre">Mon</p>
      </div>
      <div className="[grid-area:1_/_1] font-['Literata:SemiBold',_sans-serif] ml-[19.5px] mt-[15px] relative text-[32px] tracking-[1.28px] translate-x-[-50%]">
        <p className="adjustLetterSpacing block leading-[normal] text-nowrap whitespace-pre">30</p>
      </div>
    </div>
  );
}
...
function Group134() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] font-['Montserrat:SemiBold',_sans-serif] font-semibold ml-[18px] mt-0 relative text-[#667593] text-[12px] text-center text-nowrap tracking-[0.48px] translate-x-[-50%] uppercase">
        <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">Tue</p>
      </div>
      <div className="[grid-area:1_/_1] font-['Literata:SemiBold',_sans-serif] font-semibold ml-[18.5px] mt-[15px] relative text-[#667593] text-[32px] text-center text-nowrap tracking-[1.28px] translate-x-[-50%] uppercase">
        <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">28</p>
      </div>
      <div className="[grid-area:1_/_1] ml-[17px] mt-[59px] relative size-1">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 4">
          <circle cx="2" cy="2" fill="var(--fill-0, #667593)" id="Ellipse 1" r="2" />
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] font-['Montserrat:SemiBold',_sans-serif] font-semibold ml-[18.5px] mt-0 relative text-[#667593] text-[12px] text-center text-nowrap tracking-[0.48px] translate-x-[-50%] uppercase">
        <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">Wed</p>
      </div>
      <div className="[grid-area:1_/_1] font-['Literata:SemiBold',_sans-serif] font-semibold ml-[18.5px] mt-[15px] relative text-[#667593] text-[32px] text-center text-nowrap tracking-[1.28px] translate-x-[-50%] uppercase">
        <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">29</p>
      </div>
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <div className="[grid-area:1_/_1] font-['Literata:SemiBold',_sans-serif] font-semibold ml-[19.5px] mt-[15px] relative text-[#667593] text-[32px] text-center text-nowrap tracking-[1.28px] translate-x-[-50%] uppercase">
        <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">30</p>
      </div>
...
function Dates() {
  return (
    <div
      className="absolute box-border content-stretch flex gap-4 items-center justify-start left-0 p-0 top-[152px] w-[573px]"
      data-name="dates"
    >
      <Date />
      <Date1 />
...
function CalendarFill() {
  return (
    <div className="relative shrink-0 size-5" data-name="calendar-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="calendar-fill">
          <path d={svgPaths.p2431a400} fill="var(--fill-0, #F5F5F5)" id="Vector" stroke="var(--stroke-0, #F5F5F5)" />
        </g>
      </svg>
    </div>
  );
...
function BottomNav() {
  return (
    <div
      className="absolute bg-neutral-50 bottom-0 box-border content-start flex flex-wrap gap-0 h-[75px] items-start justify-center left-0 p-0 w-[375px]"
  ...
  return (
    <div className="h-6 relative shrink-0 w-[143px]" data-name="Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 143 24">
        <g clipPath="url(#clip0_62_3172)" id="Logo">
          <path d={svgPaths.p2c15ae00} fill="var(--fill-0, #47567B)" id="Zinnia" />
        </g>
        <defs>
          <clipPath id="clip0_62_3172">
...
function Header() {
  return (
    <div
      className="absolute bg-[#ffffff] box-border content-stretch flex h-[76px] items-center justify-between left-0 px-4 py-5 top-0 w-[375px]"
      data-name="Header"
    >
      <div
        aria-hidden="true"
...
function CalendarDateViewTimes() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col font-['Montserrat:Medium',_sans-serif] font-medium gap-[42px] items-start justify-start leading-[0] left-4 p-0 text-[#000000] text-[12px] top-[281px] w-[55px]"
  ...
  return (
    <div className="box-border content-stretch flex gap-1 items-center justify-start p-0 relative shrink-0">
      ...
      <div className="font-['Montserrat:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#47567b] text-[14px] text-nowrap tracking-[0.28px]">
        <p className="adjustLetterSpacing block leading-[1.5] whitespace-pre">The Garden Loft</p>
      </div>
    </div>
  );
}
...
function Frame132() {
  return (
    <div className="box-border content-stretch flex flex-col gap-1.5 items-start justify-start p-0 relative shrink-0 w-full">
      <div
        className="font-['Montserrat:Regular',_sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[#47567b] text-[14px] tracking-[0.28px]"
        style={{ width: "min-content" }}
      >
...
export default function ZinniaVendorDashboard() {
  return (
    <div className="bg-[#ffffff] relative size-full" data-name="Zinnia vendor dashboard">
      <Frame129 />
          ...
          <div className="h-0 relative w-[446px]">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 446 1">
                <line id="Line 1" stroke="var(--stroke-0, #CCD7E6)" x2="446" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
