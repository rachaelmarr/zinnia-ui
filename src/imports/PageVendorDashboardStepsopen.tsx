import svgPaths from "./svg-8uszp9eyof";
...
function Header() {
  return (
    <div
      className="bg-[#ffffff] h-[76px] relative shrink-0 w-full"
      data-name="Header"
    >
      <div className="absolute border-[#ccd7e6] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row h-[76px] items-center justify-between px-4 py-5 relative w-full">
          <LogoContainer />
          <Icons />
        </div>
      </div>
...
function TextWelcomeVendor() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-0 py-4 relative shrink-0 w-[375px]"
      data-name="Text/WelcomeVendor"
    >
      <div className="font-['Montserrat:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[#667593] text-[14px] text-center text-nowrap tracking-[0.28px]">
        <p className="adjustLetterSpacing block leading-[1.5] whitespace-pre">{`Welcome {{vendorName}}!`}</p>
      </div>
    </div>
  );
}

function GroupSetupstepsOpened() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-4 items-center justify-start p-0 relative shrink-0 w-[340px]"
      data-name="Group/setupsteps/opened"
    >
      <TextWelcomeVendor />
    </div>
  );
...
function GroupMyServices() {
  return (
    <div
      className="bg-[#ffffff] box-border content-stretch flex flex-col gap-[27px] h-[446px] items-center justify-start overflow-clip p-[20px] relative shrink-0 w-[375px]"
    ...
    >
      ...
      >
        <p className="block leading-[1.5]">Total views</p>
      </div>
      <Button />
    </div>
  );
...
function Frame154() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[46px] items-center justify-start p-0 relative shrink-0 w-full">
      <GroupSetupstepsOpened />
      <GroupCalendar />
      <GroupMyServices />
      <GroupBookings />
      <Earnings />
