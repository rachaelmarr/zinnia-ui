import svgPaths from "./svg-rrkjzphkty";
  ...
  return (
    <div className="absolute h-6 left-10 top-6 w-[143px]" data-name="Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 143 24">
        <g clipPath="url(#clip0_126_9228)" id="Logo">
          <path d={svgPaths.p2a300a00} fill="var(--fill-0, #47567B)" id="Zinnia" />
        </g>
        <defs>
          <clipPath id="clip0_126_9228">
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-4 items-start justify-start top-[97px] w-[1244px]" style={{ left: "calc(8.333% + 36px)" }}>
      <ContactHeader />
      <Table />
    </div>
  );
