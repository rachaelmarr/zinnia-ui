import svgPaths from "./svg-br4y9br281";
...
function Frame154() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-3 items-center justify-start left-[81px] p-0 top-[104px] w-[214px]">
      <Timeline />
      <div
...
function Frame10() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-[46px] items-center justify-center p-0 top-[1235px] translate-x-[-50%]"
...
function InputContainer() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row items-start justify-start left-0 pb-0 pt-0.5 px-0 top-0"
...
function BaseCheckbox() {
  return (
    <div
      className="[grid-area:1_/_1] h-[18px] ml-0 mt-0 relative w-[114px]"
...
function WrapperHyphen() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-2.5 h-[7px] items-center justify-center p-0 relative shrink-0"
...
function Hours() {
  return (
    <div
      className="[grid-area:1_/_1] box-border content-stretch flex flex-col gap-1.5 items-center justify-start ml-0 mt-[22px] pl-[25px] pr-0 py-0 relative w-[165px]"
      data-name="Hours"
    >
      <TextInput />
      <WrapperHyphen />
...
function Frame153() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-6 items-start justify-start leading-[0] left-[23px] p-0 top-[331px] w-[165px]">
      <Group146 />
      <Group147 />
      <Group148 />
      <Group149 />
...
export default function ZinniaVendorDashboard() {
  return (
    ...
    >
      ...
      <Frame154 />
      <Frame142 />
      <div className="absolute bg-neutral-50 h-[120px] left-0 top-[1203px] w-[375px]" />
      <Frame10 />
      <Frame153 />
    </div>
  );
