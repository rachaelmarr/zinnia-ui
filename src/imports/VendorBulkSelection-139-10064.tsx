import svgPaths from "./svg-ncrieswufg";
...
import { imgScreenshot20250211At80525Pm2 } from "./svg-b4z2i";
  ...
  return (
    <div className="absolute h-6 left-10 top-6 w-[143px]" data-name="Logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 143 24">
        <g clipPath="url(#clip0_139_10068)" id="Logo">
          <path d={svgPaths.p2b86a00} fill="var(--fill-0, #47567B)" id="Zinnia" />
        </g>
        <defs>
          <clipPath id="clip0_139_10068">
  ...
  return (
    <div className="relative shrink-0 size-[383px]" data-name="Illustration">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 383 383">
        <g id="Illustration">
          <path d={svgPaths.p35604780} fill="var(--fill-0, #47567B)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-3 items-center justify-start leading-[0] relative shrink-0 text-[#000000] text-center">
      <div className="font-['Literata:Medium',_sans-serif] font-medium relative shrink-0 text-[16px] tracking-[0.32px] w-[326px]">
        <p className="leading-[1.5]">No Activity</p>
      </div>
      <div className="font-['Montserrat:Regular',_sans-serif] font-normal relative shrink-0 text-[14px] tracking-[0.28px] w-[326px]">
        <p className="leading-[1.5]">Nothing here yet—start connecting and your activity will appear here!</p>
      </div>
    </div>
  );
}
...
function Frame12057() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center top-[94px] translate-x-[-50%] w-[537px]" style={{ left: "calc(50% + 54.5px)" }}>
      <Illustration />
      <Frame3 />
    </div>
  );
