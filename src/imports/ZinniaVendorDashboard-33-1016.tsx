import svgPaths from "./svg-ou47lv6jk";
      ...
      <div className="[grid-area:1_/_1] ml-[17px] mt-[59px] relative size-1">
        ...
        >
          <circle
            cx="2"
            cy="2"
            fill="url(#paint0_linear_33_1058)"
            id="Ellipse 1"
            r="2"
          />
          <defs>
...
function Dates() {
  return (
    <div
      className="absolute left-0 top-[152px] w-[375px] h-[87px] overflow-hidden"
      data-name="dates-container"
    >
      <div
        className="flex flex-row gap-4 items-center justify-start p-0 px-4 overflow-x-auto scrollbar-hide"
        style={{ 
          width: 'max-content',
...
function BottomNav() {
  return (
    <div
      className="fixed bottom-0 left-1/2 transform -translate-x-1/2 bg-neutral-50 box-border content-start flex gap-0 h-[75px] items-start justify-center p-0 w-[375px] z-50"
  ...
  return (
    <div className="h-6 relative shrink-0 w-[143px]" data-name="Logo">
      <svg
        ...
        viewBox="0 0 143 24"
      >
        <g clipPath="url(#clip0_33_1030)" id="Logo">
          <path
            d={svgPaths.pb289280}
...
function Header() {
  return (
    <div
      className="absolute bg-[#ffffff] box-border content-stretch flex flex-row h-[76px] items-center justify-between left-0 px-4 py-5 top-0 w-[375px] z-10"
      data-name="Header"
    >
      <div
        aria-hidden="true"
...
function CalendarDateViewTimes() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col font-['Montserrat:Medium',_sans-serif] font-medium gap-[42px] items-start justify-start leading-[0] left-4 p-0 text-[#000000] text-[12px] text-left top-[281px] w-[55px] z-10"
...
function Calendar() {
  return (
    <div
      className="absolute bg-purple-100 box-border content-stretch flex flex-col gap-2.5 items-start justify-center left-[110px] p-[12px] top-[281px] w-[203px] z-20"
      style={{ 
        height: 'calc(100vh - 281px - 75px - 20px)' // Account for header, bottom nav, and some padding
      }}
      data-name="Calendar"
    >
      <Frame132 />
...
function ScrollableContent() {
  return (
    <div
      className="absolute left-0 top-[76px] w-[375px] overflow-y-auto z-0"
      style={{ 
        height: 'calc(100vh - 76px - 75px)', // Account for header and bottom nav
        paddingBottom: '20px'
      }}
      data-name="scrollable-content"
    >
      <Frame129 />
      <div className="absolute flex h-[446px] items-center justify-center left-[353px] top-[220px] w-[0px]">
...
export default function ZinniaVendorDashboard() {
  return (
    <div
      className="bg-[#ffffff] relative w-[375px] mx-auto min-h-screen overflow-hidden"
